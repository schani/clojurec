...
(deftest numbers
  (testing "simple numbers"
    (is (= (run '(cljc.core/print (+))) [0]))
    (is (= (run '(cljc.core/print (+ 1))) [1]))
    (is (= (run '(cljc.core/print (+ 1.0))) [1.0]))
    (is (= (run '(cljc.core/print (+ 1 2))) [3]))
    (is (= (run '(cljc.core/print (+ 1.0 2))) [3.0]))
    (is (= (run '(cljc.core/print (+ 1.0 2.0))) [3.0]))
    (is (= (run '(cljc.core/print (+ 1.0 2.0 4.0))) [7.0]))
    (is (= (run '(cljc.core/print (- 1))) [-1]))
    (is (= (run '(cljc.core/print (- 1.0))) [-1.0]))
    (is (= (run '(cljc.core/print (- 1 2))) [-1]))
    (is (= (run '(cljc.core/print (- 1 2 3))) [-4]))
    (is (= (run '(cljc.core/print (- 1 2.0 3))) [-4.0]))
    (is (= (run '(cljc.core/print (*))) [1]))
    (is (= (run '(cljc.core/print (* 1))) [1]))
    (is (= (run '(cljc.core/print (* 1.0))) [1.0]))
    (is (= (run '(cljc.core/print (* 1 2))) [2]))
    (is (= (run '(cljc.core/print (* 1 2 3))) [6]))
    (is (= (run '(cljc.core/print (* 1 2 3.0))) [6.0]))
    (is (= (core-run '(cljc.core/print (apply + ()))) [0]))
    (is (= (core-run '(cljc.core/print (apply + '(1)))) [1]))
    (is (= (core-run '(cljc.core/print (apply + '(1 2)))) [3]))
    (is (= (core-run '(cljc.core/print (apply + '(1 2.0)))) [3.0]))
    (is (= (core-run '(cljc.core/print (apply - '(1 2 3)))) [-4]))
    (is (= (core-run '(cljc.core/print (apply - '(1 2.0 3)))) [-4.0]))
    (is (= (core-run '(cljc.core/print (apply * '()))) [1]))
    (is (= (core-run '(cljc.core/print (apply * '(1 2 3)))) [6]))
    (is (= (core-run '(cljc.core/print (apply * '(1 2 3.0)))) [6.0]))
    (is (= (run '(cljc.core/print (zero? nil))) [false]))
    (is (= (run '(cljc.core/print (zero? 0))) [true]))
    (is (= (run '(cljc.core/print (zero? 1))) [false]))
    (is (= (run '(cljc.core/print (zero? 0.0))) [true]))
    (is (= (run '(cljc.core/print (zero? 1.0))) [false]))
    (is (= (run '(cljc.core/print (float? 1.0))) [true]))
    (is (= (run '(cljc.core/print (float? 1))) [false]))
    (is (= (run '(cljc.core/print (< 1 2))) [true]))
    (is (= (run '(cljc.core/print (< 1 1))) [false]))
    (is (= (run '(cljc.core/print (< 1.0 1))) [false]))
    (is (= (run '(cljc.core/print (< 2 1))) [false]))
    (is (= (run '(cljc.core/print (< 2 1.0))) [false]))
    (is (= (run '(cljc.core/print (> 2 1.0))) [true]))
    (is (= (run '(cljc.core/print (>= 2 1))) [true]))
    (is (= (run '(cljc.core/print (>= 2 1.0))) [true]))
    (is (= (core-run '(do
			(print (dec 1))
			(print (inc 1))))
